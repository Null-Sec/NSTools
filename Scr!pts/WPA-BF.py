...
def ShowTutorial1():
    ...
    print fcolor.SWhite + "    ==================================================================================================="
    print fcolor.SWhite + "     1.   \"Testing\"            FB:CD:EF:F0:11:22    WPA2        1     2.412 GHz    -66 dBm    44/70"
    print fcolor.SWhite + "     2.   \"Null-Sec\"           FF:FF:FF:FF:FF:FF    WPA/WPA2    6     2.437 GHz    -48 dBm    62/70"
    ...
    print fcolor.SWhite + "     Selected ESSID ==> \"Null-Sec\""
    print fcolor.SWhite + ""
    print fcolor.SWhite + "[i]  Dictionary Selection"
    print fcolor.SWhite + "[?]  Enter the dictionary to use for the attack ( Default : /usr/share/Heidy/password.lst ) : "+ fcolor.BRed + "\t<-- Enter dictionary here"
    print fcolor.SWhite + "     Selected Dictionary ==> /usr/share/Heidy/password.lst - [25.02 KB]"
    print fcolor.SWhite + ""
    ...
    print fcolor.SWhite + "     Target Access Point: \"Null-Sec\""
    print fcolor.SWhite + "     Dictionary to use	: /usr/share/Heidy/password.lst"
    ...
    print fcolor.SWhite + "[.]  Trying   [ riskysucks ]....  Connection Error !!"+ fcolor.BRed + "\t\t<-- If connection error, it will extend the timeout delay timing"
    print fcolor.SWhite + "[.]  Trying   [ riskysucks ] with 30.0 seconds delay.. Failed !!"+ fcolor.BRed + "\t<-- Failed indicated that key is unable to test."
    ...
    print fcolor.SWhite + "[.]  Trying   [ poopbreath ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ clefttit ]....  Wrong Key !"
    ...
    print fcolor.SWhite + "[.]  Trying   [ asshole ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ iloveme ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ ashite ].... Connection Error !!"
    print fcolor.SWhite + "[.]  Retrying [ ashite ] with 30.0 seconds delay.. Failed !!"
    print fcolor.SWhite + "[.]  Trying   [ crackme ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ whore<3slut ]....  Successful.... " + fcolor.BRed + "\t<-- If correct passphrase is found, it will display 'Successful'"
    print fcolor.SWhite + "[i]  WPA Passphrase Found !!"+ fcolor.BRed + "\t\t\t\t    with the correct passphrase shown."
    print fcolor.SWhite + "     ESSID	[ \"Null-Sec\" ]"
    ...
    print fcolor.SWhite + "     ESSID	   : \"Null-Sec\""+ fcolor.BRed + "\t\t\t\t\t    it will display the previous setting."
    print fcolor.SWhite + "     Interface	   : wlan0"
    print fcolor.SWhite + "     Dictionary	   : /usr/share/Heidy/password.lst"
    ...
    print fcolor.SWhite + "[.]  Trying   [ 1234567890 ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ 4135614313 ]....  Wrong Key !"+ fcolor.BRed + "\t\t<-- If wrong passphrase, it will display 'Wrong Key'"
    print fcolor.SWhite + "[.]  Trying   [ 6453423433 ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ 1276384899 ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ 2734629283 ]....  Wrong Key !"
    print fcolor.SWhite + "[i]  Remain keys to try  :  626		- 1.57 % completed."+ fcolor.BRed + "\t\t<-- With every 10 key tried, it will display a summary"
    print fcolor.SWhite + "     Remaing Time Needed  : 2:36:30	- Basing on current average delay rate : 15 seconds"
    print fcolor.SWhite + "     Est. Completion      : 2014-01-06 04:07:34"+ fcolor.BRed + "\t\t\t<-- showing time needed and estimated completion date/time."
    print fcolor.SWhite + "[.]  Trying   [ 56784534 ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ 72354827 ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ 32487987 ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ 22376870 ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ 48789798 ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ 12341234 ].... Connection Error !!"+ fcolor.BRed + "\t\t<-- If connection error, it will extend the timeout delay timing"
    print fcolor.SWhite + "[.]  Retrying [ 12341234 ] with 30.0 seconds delay.. Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ 00112233 ]....  Wrong Key !"
    print fcolor.SWhite + "[.]  Trying   [ 13378055 ]....  Successful.... " + fcolor.BRed + "\t<-- If correct passphrase is found, it will display 'Successful'"
    print fcolor.SWhite + "[i]  WPA Passphrase Found !!"+ fcolor.BRed + "\t\t\t\t    with the correct passphrase shown."
    print fcolor.SWhite + "     ESSID	[ \"Null-Sec\" ]"
    print fcolor.SWhite + "     Passphrase	[ " + fcolor.BWhite + "MySuperPassword" + fcolor.SWhite + " ]"
    print fcolor.SWhite + ""
...
def GetUpdate(ExitMode):
    ...
    github="https://github.com/Null-Sec/NSTools/Scr!pts/WPA-BF.py"
...
def DisplayDetailHelp():
    ...
    print fcolor.BGreen + "          " + fcolor.BYellow + "" + DScriptName + fcolor.BWhite + " --iface " + fcolor.BBlue + "wlan1" + fcolor.BWhite + " --timeout " + fcolor.BBlue + "20"+ fcolor.BWhite + " --essid " + fcolor.BBlue + "\"Null-Sec\""
...
try:
    ...
    if PrevLogFound==0 or PrevLogFound==1:
        ...
        print ""
        if SELECTED_DICT=="":
            DDict="/usr/share/Heidy/password.lst"
