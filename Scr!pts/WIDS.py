...
appver="1.0, R.9"
apptitle="WIDS"
appDesc="Wireless Intrusion Detection System"
...
def GetUpdate(ExitMode):
    ...
    github="https://github.com/Null-Sec/NSTools/Scr!pts/WIDS.py"
...
MyMAC=""
appdir="/NSTools/WIDS/"
macoui="/NSTools/WIDS/mac-oui.db"
PathList = ['tmp/']
tmpdir=appdir + "tmp/"
...
try:
    ...
    time.sleep(0.1)
    print fcolor.BWhite + "Please support by liking my page at " + fcolor.BBlue + "https://www.Null-Sec.ru" +fcolor.BWhite + "(Null-Sec Scr!pts)"
